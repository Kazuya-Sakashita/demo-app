...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference("Dog.count") do
      post dogs_url, params: { dog: { birthday: @dog.birthday, description: @dog.description, name: @dog.name } }
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { birthday: @dog.birthday, description: @dog.description, name: @dog.name } }
